...
def defence(char_name: str,
            char_class: str) -> str:
    """Implement the defence mechanic."""
    if char_class == 'warrior':
...
def special(char_name: str,
            char_class: str) -> str:
    """Implement the use of special abilities."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    Promts the user with available classes,
    reads user input and returns the choice.
    """
    approve_choice: str = ''
    char_class: str = ''
